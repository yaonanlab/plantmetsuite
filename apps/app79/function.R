...
source("/srv/myapps/keyandaydayup/apps/app79/plot.R",encoding = "UTF-8")
taskidnow<-args[1]
app79_select1<-args[2]
app79_select2<-args[3]
app79_select3<-args[4]
app79_select4<-args[5]
app79_select5<-args[6]
app79_select6<-args[7]
app79_text1<-args[8]
app79_text2<-args[9]
app79_text3<-args[10]
app79_text4<-args[11]
...
if(app79_email!=""&("TRUE"%in%grepl("@",app79_email))){
setwd("/srv/myapps/keyandaydayup/")
tar(file.path("userdata",taskidnow,"result.zip"),files=file.path("userdata",taskidnow,"result"))
attach.file <- file.path("/srv/myapps/keyandaydayup/userdata",taskidnow,"result.zip")
sendmail(to=as.character(app79_email),attach=T,attach.file=attach.file)
}
