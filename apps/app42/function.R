...
source("/srv/myapps/keyandaydayup/apps/app42/plot.R",encoding = "UTF-8")
taskidnow<-args[1]
app42_select1<-args[2]
app42_select2<-args[3]
app42_select3<-args[4]
app42_select4<-args[5]
app42_select5<-args[6]
app42_text1<-args[7]
app42_text2<-args[8]
app42_text3<-args[9]
app42_text4<-args[10]
...
app42_text8<-args[14]
app42_text9<-args[15]
app42_text10<-args[16]
app42_text11<-args[17]
app42_text12<-args[18]
app42_text13<-args[19]
app42_email<-args[20]
...
if(app42_email!=""&("TRUE"%in%grepl("@",app42_email))){
setwd("/srv/myapps/keyandaydayup/")
tar(file.path("userdata",taskidnow,"result.zip"),files=file.path("userdata",taskidnow,"result"))
attach.file <- file.path("/srv/myapps/keyandaydayup/userdata",taskidnow,"result.zip")
sendmail(to=as.character(app42_email),attach=T,attach.file=attach.file)
}
