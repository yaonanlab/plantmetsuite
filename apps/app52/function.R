...
source("/srv/myapps/keyandaydayup/apps/app52/plot.R",encoding = "UTF-8")
taskidnow<-args[1]
app52_select1<-args[2]
app52_select2<-args[3]
app52_text1<-args[4]
app52_text2<-args[5]
app52_text3<-args[6]
app52_text4<-args[7]
...
if(app52_email!=""&("TRUE"%in%grepl("@",app52_email))){
setwd("/srv/myapps/keyandaydayup/")
tar(file.path("userdata",taskidnow,"result.zip"),files=file.path("userdata",taskidnow,"result"))
attach.file <- file.path("/srv/myapps/keyandaydayup/userdata",taskidnow,"result.zip")
sendmail(to=as.character(app52_email),attach=T,attach.file=attach.file)
}
