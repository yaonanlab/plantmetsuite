      ...
      tabBox(
        ...
        height = 100,
		 tabPanel(
          title = "Result",
		  br(),
		  		  div(style="text-align:center;",fluidRow(column(11, br(),span(strong("Example result"),style="font-size:20px;text-align:center;"),br(),br(),img(src = "app111/app111.png", height = 300),br()))),
        ...
        tabPanel(
          ...
          ),fluidRow(column(11,includeHTML("apps/app111/video.html"))
        )),tabPanel(
          title = "Instructions",
          div(
            style = "position: absolute; left: 0.5em; bottom: 0.5em;"
          ),fluidRow(column(11,includeHTML("apps/app111/manual.html"))
        )),tabPanel(
          title = "FAQ",
          div(
            style = "position: absolute; left: 0.5em; bottom: 0.5em;"
          ),fluidRow(column(11,includeHTML("apps/app111/question.html"))
        ))
      )
    )
  })  
