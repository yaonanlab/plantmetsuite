...
renderUI({
    div(
      ...
      tabBox(
        ...
        height = NULL,
        tabPanel(
          title = img(src = 'app1.png', height = '40px', width = '40px',style="display: inline;"),
          div(
            style = "position: absolute; left: 0.5em; bottom: 0.5em;display:inline;"
          ),div(h3(strong("Heat Map")), h4("Heat map with tabular data"),style="text-align: center;display:inline;",
		  h4("Required field",style="text-align: left;font-weight: 1000;color:red"),
		  div(id = "app1_fileupload",
                            tags$style("
                            .btn-file {
                 ...
                 style = "color: white; 
					   ...
					   vertical-align:middle;
					   "), target = "_blank",
                            href = "app1/heatmap.txt"),a(h4("Download sample data", class = "action-button", 
                 style = "color: white; 
                       background-color: #53d362; 
                       height: 40px;
                       width: 90px;
					   ...
					   "), target = "_blank",
							...
							colourInput("app1_text1", "", value = "#436fa9"),
							colourInput("app1_text2", "", value = "#ffffff"),
							colourInput("app1_text3", "", value = "#d04030"),
h4("字体大小",style="text-align: left;font-weight: 1000;color:black"),
fluidRow(column(width=2,textAreaInput("app1_text4", "","8", width = "90px",height="40px",))),
...
div(textAreaInput("app1_email", "","", width = "100%",height="40px"),style="text-align: center;font-weight: 1000;color:red"),
							actionButton(
                 inputId = "send_button",
                 label = "Submit",
                 styleclass = "info",
