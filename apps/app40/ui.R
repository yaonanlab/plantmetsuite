...
renderUI({
    div(
      ...
      tabBox(
        ...
        height = NULL,
        tabPanel(
          title = img(src = 'app40.png', height = '40px', width = '40px',style="display: inline;"),
          div(
            style = "position: absolute; left: 0.5em; bottom: 0.5em;display:inline;"
          ),div(h3(strong("Histogram")), h4("Histogram with tabular data"),style="text-align: center;display:inline;",
		  h4("Required field",style="text-align: left;font-weight: 1000;color:red"),
		  div(id = "app40_fileupload",
                            tags$style("
                            .btn-file {
                 ...
                 style = "color: white; 
					   ...
					   vertical-align:middle;
					   "), target = "_blank",
                            href = "app40/data.txt"),a(h4("Download sample data", class = "action-button", 
                 style = "color: white; 
                       background-color: #53d362; 
                       height: 40px;
                       width: 90px;
...
fluidRow(column(width=12,
							colourInput("app40_text1", "", value = "#f682af"),
							colourInput("app40_text2", "", value = "#9379e6"),
							colourInput("app40_text3", "", value = "#efb94d"),
							colourInput("app40_text4", "", value = "#77c0c7"),
							colourInput("app40_text5", "", value = "#f26949"))),
h4("Title",style="text-align: left;font-weight: 1000;color:black"),
fluidRow(column(width=2,textAreaInput("app40_text6", "","Plot", width = "180px",height="40px"))),
h4("X-axis label",style="text-align: left;font-weight: 1000;color:black"),
fluidRow(column(width=2,textAreaInput("app40_text7", "","x", width = "180px",height="40px"))),
h4("Y-axis label",style="text-align: left;font-weight: 1000;color:black"),
fluidRow(column(width=2,textAreaInput("app40_text8", "","y", width = "180px",height="40px"))),
#插入slider	
h4("Number of groups (default is 30)",style="text-align: left;font-weight: 1000;color:black"),
fluidRow(column(width=5,sliderInput("app40_slider1",width = "300px",
"",
                  min = 1,
                  max = 50,
                  value = 30))),	
h4("Data bar orientation",style="text-align: left;font-weight: 1000;color:black"),
fluidRow(align = "left",column(12,selectizeInput(
                                "app40_select1",
                                "",
                                choices = list('Data bar orientation' = c(`Vertical` = "0",`Horizontal` = "1")),
                                multiple = F,
                                options = list(placeholder = ''),
                                selected = ""
                            ))),						
h4("Overlay Type",style="text-align: left;font-weight: 1000;color:black"),
fluidRow(align = "left",column(12,selectizeInput(
                                "app40_select2",
                                "",
                                choices = list(
                               'Overlay Type' = c(`Stacking` = "0",`Pileup` = "1")),
                                multiple = F,
                                options = list(placeholder = ''),
                                selected = ""
                            ))),		
...
div(textAreaInput("app40_email", "","", width = "100%",height="40px"),style="text-align: center;font-weight: 1000;color:red"),
							actionButton(
                 inputId = "send_button",
                 label = "Submit",
                 styleclass = "info",
