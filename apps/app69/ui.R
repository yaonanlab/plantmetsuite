...
renderUI({
    div(
      ...
      tabBox(
        ...
        height = NULL,
        tabPanel(
          title = img(src = 'app69.png', height = '40px', width = '40px',style="display: inline;"),
          div(
            style = "position: absolute; left: 0.5em; bottom: 0.5em;display:inline;"
          ),div(h3(strong("DEseq no replicate")), h4("Differential expression analysis based on matrix"),style="text-align: center;display:inline;",
		  h4("Required field",style="text-align: left;font-weight: 1000;color:red"),
		  div(id = "app69_fileupload",
                            tags$style("
                            .btn-file {
                 ...
                 style = "color: white; 
					   ...
					   vertical-align:middle;
					   "), target = "_blank",
                            href = "app69/count.xls"),a(h4("Download sample data", class = "action-button", 
                 style = "color: white; 
                       background-color: #53d362; 
                       height: 40px;
                       width: 90px;
                 ...
                 style = "color: white; 
					   ...
					   vertical-align:middle;
					   "), target = "_blank",
                            href = "app69/condition.txt"),a(h4("Download sample data", class = "action-button", 
                 style = "color: white; 
                       background-color: #53d362; 
                       height: 40px;
                       width: 90px;
					...
					fluidRow(column(width=12,textAreaInput("app69_text1", "","Mutant,Wildtype", width = "180px",height="40px"))),		
					h4("Foldchange",style="text-align: left;font-weight: 1000;color:black"),
					fluidRow(column(width=12,textAreaInput("app69_text2", "","2", width = "180px",height="40px"))),
					h4("Pvalue",style="text-align: left;font-weight: 1000;color:black"),
					fluidRow(column(width=12,textAreaInput("app69_text3", "","0.05", width = "180px",height="40px"))),
					h4("Qvalue",style="text-align: left;font-weight: 1000;color:black"),
					fluidRow(column(width=12,textAreaInput("app69_text4", "","0.05", width = "180px",height="40px"))),
h4("Send results to email after completion",style="text-align: left;font-weight: 1000;color:red"),
div(textAreaInput("app69_email", "","", width = "100%",height="40px"),style="text-align: center;font-weight: 1000;color:red"),
							actionButton(
                 inputId = "send_button",
                 label = "Submit",
                 styleclass = "info",
