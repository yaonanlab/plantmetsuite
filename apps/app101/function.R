...
source("/srv/myapps/keyandaydayup/scripts/app101/standardization_normalization.R")
taskidnow<-args[1]
app101_select1<-args[2]
app101_text1<-args[3]
app101_email<-args[4]
taskidnow<-as.character(taskidnow)
app101_select1 <- as.numeric(app101_select1)
app101_email <- as.character(app101_email)
...
if(app101_email!=""&("TRUE"%in%grepl("@",app101_email))){
setwd("/srv/myapps/keyandaydayup/")
tar(file.path("userdata",taskidnow,"result.zip"),files=file.path("userdata",taskidnow,"result"))
attach.file <- file.path("/srv/myapps/keyandaydayup/userdata",taskidnow,"result.zip")
sendmail(to=as.character(app101_email),attach=T,attach.file=attach.file)
}
