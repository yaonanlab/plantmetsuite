...
renderUI({
    div(style = "position: relative; backgroundColor: #ecf0f5",
        ...
        height = NULL,
        tabPanel(
          title = img(src = 'app92.png', height = '40px', width = '40px',style="display: inline;"),
          div(
...
fluidRow(column(width=5,fileInput(
    ...
    column(width=2,column(width=12,a(h4("View Data Format", class = "action-button", 
		...
		vertical-align:middle;"), 
		target = "_blank",
        href = "app92/spectrum1.txt"),a(h4("Get sample data", class = "action-button", 
        style = "color: white; 
        background-color: #53d362; 
        height: 40px;
        width: 90px;
...
fluidRow(column(width=5,fileInput(
    ...
    column(width=2,column(width=12,a(h4("View sample Format", class = "action-button", 
		...
		vertical-align:middle;"), 
		target = "_blank",
        href = "app92/spectrum2.txt"),a(h4("Get sample data", class = "action-button", 
        style = "color: white; 
        background-color: #53d362; 
        height: 40px;
        width: 90px;
...
br(),
	...
	fluidRow(column(width=2,textAreaInput("app92_text1", "","90", width = "180px",height="40px"))),
	h4("Ms2 mass-to-charge ratio range of mass spectra (upper limit)",style="text-align: left;font-weight: 1000;color:black"),
	fluidRow(column(width=2,textAreaInput("app92_text2", "","120", width = "180px",height="40px"))),
	
	h4("Ms2 fragment matching ppm",style="text-align: left;font-weight: 1000;color:black"),	
	fluidRow(column(width=2,textAreaInput("app92_text3", "","30", width = "180px",height="40px"))),
	
	h4("Threshold value for mass-to-charge ratio error calculation",style="text-align: left;font-weight: 1000;color:black"),
	fluidRow(column(width=2,textAreaInput("app92_text4", "","400", width = "180px",height="40px"))),
...
br(),
	...
	fluidRow(column(width=12,
		colourInput("app92_text5", "", value = "#776AAE"),
		colourInput("app92_text6", "", value = "#5EBED6"))),	
	h4("X-axis label",style="text-align: left;font-weight: 1000;color:black"),
	fluidRow(column(width=2,textAreaInput("app92_text7", "","Mass to charge ratio (m/z)", width = "180px",height="40px"))),
	h4("Y-axis label",style="text-align: left;font-weight: 1000;color:black"),
	fluidRow(column(width=2,textAreaInput("app92_text8", "","Relative intensity", width = "180px",height="40px"))),
	
	
h4("Send results to email upon completion",style="text-align: left;font-weight: 1000;color:red"),
div(textAreaInput("app92_email", "","", width = "100%",height="40px"),style="text-align: center;font-weight: 1000;color:red"),
							actionButton(
                 inputId = "send_button",
                 label = "Submit",
                 styleclass = "info",
