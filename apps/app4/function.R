...
app4_text7<-args[8]
app4_email<-args[9]
app4_text1<-as.character(app4_text1)
app4_text2<-as.character(app4_text2)
app4_text3<-as.character(app4_text3)
app4_text4<-as.character(app4_text4)
app4_text5<-as.character(app4_text5)
app4_text6<-as.numeric(as.character((app4_text6)))
app4_text7<-as.numeric(as.character((app4_text7)))
app4_email <- as.character(app4_email)
...
v <- venn.diagram(list(A=a, B=b),cat.pos = 0,rotation.degree=90,fill = c(app4_text1, app4_text2),alpha = c(0.5, 0.5), cat.cex = app4_text6, cex=app4_text7,filename=NULL,category.names=names(data),scale=F)
grid.newpage()
grid.draw(v)
}
...
if(app4_email!=""&("TRUE"%in%grepl("@",app4_email))){
setwd("/srv/myapps/keyandaydayup/")
tar(file.path("userdata",taskidnow,"result.zip"),files=file.path("userdata",taskidnow,"result"))
attach.file <- file.path("/srv/myapps/keyandaydayup/userdata",taskidnow,"result.zip")
sendmail(to=as.character(app4_email),attach=T,attach.file=attach.file)
}
