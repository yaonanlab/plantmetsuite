    ...
    div(
      ...
      tabBox(
		...
		tabPanel(
          ...
          div(
            style = "position: absolute; left: 0.5em; bottom: 0.5em;"
		  		  ...
		  		  div(style="text-align:center;",fluidRow(column(11, br(),span(strong("Example result"),style="font-size:20px;text-align:center;"),br(),br(),img(src = "app53/app53.png", height = 300),br()))),
        ...
        tabPanel(
          ...
          div(
            style = "position: absolute; left: 0.5em; bottom: 0.5em;"
          ),fluidRow(column(11,includeHTML("apps/app53/video.html"))
        )),tabPanel(
          title = "Instructions",
          div(
            style = "position: absolute; left: 0.5em; bottom: 0.5em;"
          ),fluidRow(column(11,includeHTML("apps/app53/manual.html"))
        )),tabPanel(
          title = "FAQ",
          div(
            style = "position: absolute; left: 0.5em; bottom: 0.5em;"
          ),fluidRow(column(11,includeHTML("apps/app53/question.html"))
        ))
      )
    )
  })  
