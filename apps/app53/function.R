...
source("/srv/myapps/keyandaydayup/apps/app53/plot.R",encoding = "UTF-8")
taskidnow<-args[1]
app53_text1<-args[2]
app53_text2<-args[3]
app53_text3<-args[4]
...
if(app53_email!=""&("TRUE"%in%grepl("@",app53_email))){
setwd("/srv/myapps/keyandaydayup/")
tar(file.path("userdata",taskidnow,"result.zip"),files=file.path("userdata",taskidnow,"result"))
attach.file <- file.path("/srv/myapps/keyandaydayup/userdata",taskidnow,"result.zip")
sendmail(to=as.character(app53_email),attach=T,attach.file=attach.file)
}
