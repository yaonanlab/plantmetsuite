...
renderUI({
    div(
      ...
      tabBox(
        ...
        height = NULL,
        tabPanel(
          title = img(src = 'app58.png', height = '40px', width = '40px',style="display: inline;"),
          div(
            style = "position: absolute; left: 0.5em; bottom: 0.5em;display:inline;"
          ),div(h3(strong("Correlation regression chart")), h4("Correlation regression plots with tabular data"),style="text-align: center;display:inline;",
		  h4("Required field",style="text-align: left;font-weight: 1000;color:red"),
		  div(id = "app58_fileupload",
                            tags$style("
                            .btn-file {
                 ...
                 style = "color: white; 
					   ...
					   vertical-align:middle;
					   "), target = "_blank",
                            href = "app58/data.txt"),a(h4("Download sample data", class = "action-button", 
                 style = "color: white; 
                       background-color: #53d362; 
                       height: 40px;
                       width: 90px;
...
fluidRow(column(width=12,
							colourInput("app58_text1", "", value = "#4654A6"),
							)),
h4("Regression line color",style="text-align: left;font-weight: 1000;color:black"),
fluidRow(column(width=12,
							colourInput("app58_text2", "", value = "#B833A2"),
							)),
h4("Return to area color",style="text-align: left;font-weight: 1000;color:black"),
fluidRow(column(width=12,
							colourInput("app58_text3", "", value = "#E88BD9"),
							)),							
h4("Title",style="text-align: left;font-weight: 1000;color:black"),
fluidRow(column(width=2,textAreaInput("app58_text6", "","Plot", width = "180px",height="40px"))),
h4("X-axis label",style="text-align: left;font-weight: 1000;color:black"),
fluidRow(column(width=2,textAreaInput("app58_text7", "","x", width = "180px",height="40px"))),
h4("Y-axis label",style="text-align: left;font-weight: 1000;color:black"),
fluidRow(column(width=2,textAreaInput("app58_text8", "","y", width = "180px",height="40px"))),
#插入slider	
h4("Regression algorithm",style="text-align: left;font-weight: 1000;color:black"),
fluidRow(align = "left",column(12,selectizeInput(
                                "app58_select1",
                                "",
                                choices = list('Regression algorithm' = c(`reg.line` = "reg.line",`loess` = "loess")),
                                multiple = F,
                                options = list(placeholder = ''),
                                selected = ""
                            ))),						
h4("Correlation algorithm",style="text-align: left;font-weight: 1000;color:black"),
fluidRow(align = "left",column(12,selectizeInput(
                                "app58_select2",
                                "",
                                choices = list(
                               'Correlation algorithm' = c(`pearson` = "pearson",`spearman` = "spearman",`kendall` = "kendall")),
                                multiple = F,
                                options = list(placeholder = ''),
                                selected = ""
                            ))),		
h4("Show confidence interval",style="text-align: left;font-weight: 1000;color:black"),
fluidRow(align = "left",column(12,selectizeInput(
                                "app58_select3",
                                "",
                                choices = list(
                               'Show confidence interval' = c(`Yes` = "1",`No` = "0")),
                                multiple = F,
                                options = list(placeholder = ''),
                                selected = ""
                            ))),								
h4("Send results to email after completion",style="text-align: left;font-weight: 1000;color:red"),
div(textAreaInput("app58_email", "","", width = "100%",height="40px"),style="text-align: center;font-weight: 1000;color:red"),
							actionButton(
                 inputId = "send_button",
                 label = "Submit",
                 styleclass = "info",
