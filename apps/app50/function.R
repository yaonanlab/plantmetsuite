...
source("/srv/myapps/keyandaydayup/apps/app50/plot.R",encoding = "UTF-8")
taskidnow<-args[1]
app50_text1<-args[2]
app50_text2<-args[3]
app50_text3<-args[4]
...
if(app50_email!=""&("TRUE"%in%grepl("@",app50_email))){
setwd("/srv/myapps/keyandaydayup/")
tar(file.path("userdata",taskidnow,"result.zip"),files=file.path("userdata",taskidnow,"result"))
attach.file <- file.path("/srv/myapps/keyandaydayup/userdata",taskidnow,"result.zip")
sendmail(to=as.character(app50_email),attach=T,attach.file=attach.file)
}
