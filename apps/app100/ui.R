appUI<-function(input,output){
    ...
    div(
      ...
      tabBox(
        ...
        height = NULL,
        tabPanel(
          title = img(src = 'app100.png', height = '40px', width = '40px',style="display: inline;"),
          div(
            style = "position: absolute; left: 0.5em; bottom: 0.5em;display:inline;"
          ),div(h3(strong("MetCleaning")), h4("Batch processing of missing values in tables"),style="text-align: center;display:inline;",
		h4("Required field",style="text-align: left;font-weight: 1000;color:red"),
		  div(id = "app100_fileupload",
                            tags$style("
                            .btn-file {
		...
		h4("Select the table data to be calculated：txt(tabular separator)、csv、xls、xlsx",style="text-align: left;font-weight: 1000;")
                 ...
                 style = "color: white; 
					   ...
					   vertical-align:middle;
					   "), target = "_blank",
                            href = "app100/data.txt"),a(h4("Download sample data", class = "action-button", 
                 style = "color: white; 
                       background-color: #53d362; 
                       height: 40px;
                       width: 90px;
...
div(id = 'app100_button1_info1',
h4("Please enter the missing value form：",style="text-align: left;font-weight: 1000;")),
div(id = 'app100_button1',
br(),
fluidRow(column(width=2,textAreaInput("app100_text1", "","NULL", width = "180px",height="40px")))),
...
div(id = 'app100_button2_info1',
h4("Please enter the missing percentage：",style="text-align: left;font-weight: 1000;")),						
div(id = 'app100_button2',
br(),
fluidRow(column(width=2,textAreaInput("app100_text2", "","0.2", width = "180px",height="40px")))),	
	
	  h4("Send results to email after completion",style="text-align: left;font-weight: 1000;color:red"),
div(textAreaInput("app100_email", "","", width = "100%",height="40px"),style="text-align: center;font-weight: 1000;color:red"),
							actionButton(
                 inputId = "send_button",
                 label = "Submit",
                 styleclass = "info",
