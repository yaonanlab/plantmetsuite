...
renderUI({
    div(
      ...
      tabBox(
        ...
        height = NULL,
        tabPanel(
          title = img(src = 'app87.png', height = '40px', width = '40px',style="display: inline;"),
          div(
            style = "position: absolute; left: 0.5em; bottom: 0.5em;display:inline;"
          ),div(h3(strong("Air bubble diagram")), h4("Plotting bubble charts with tabular data"),style="text-align: center;display:inline;",
		  h4("Required field",style="text-align: left;font-weight: 1000;color:red"),
		  div(id = "app87_fileupload",
                            tags$style("
                            .btn-file {
                 ...
                 style = "color: white; 
					   ...
					   vertical-align:middle;
					   "), target = "_blank",
                            href = "app87/data.txt"),a(h4("Download sample data", class = "action-button", 
                 style = "color: white; 
                       background-color: #53d362; 
                       height: 40px;
                       width: 90px;
...
fluidRow(column(width=12,
							colourInput("app87_text1", "", value = "#ACCD03"),
							colourInput("app87_text2", "", value = "#E07EA0"),
							colourInput("app87_text3", "", value = "#FFD101"),
							colourInput("app87_text4", "", value = "#5EBED6"),
							colourInput("app87_text5", "", value = "#776AAE"))),
h4("Transparency",style="text-align: left;font-weight: 1000;color:black"),
fluidRow(column(width=2,textAreaInput("app87_text6", "","0.5", width = "180px",height="40px"))),
h4("Title",style="text-align: left;font-weight: 1000;color:black"),
fluidRow(column(width=2,textAreaInput("app87_text7", "","Plot", width = "180px",height="40px"))),
h4("X-axis label",style="text-align: left;font-weight: 1000;color:black"),
fluidRow(column(width=2,textAreaInput("app87_text8", "","X", width = "180px",height="40px"))),
h4("Y-axis label",style="text-align: left;font-weight: 1000;color:black"),
fluidRow(column(width=2,textAreaInput("app87_text9", "","Y", width = "180px",height="40px"))),
h4("Distribution range of points (maximum)",style="text-align: left;font-weight: 1000;color:black"),
fluidRow(column(width=2,textAreaInput("app87_text10", "","30", width = "180px",height="40px"))),
h4("Range of distribution of points (minimum)",style="text-align: left;font-weight: 1000;color:black"),
fluidRow(column(width=2,textAreaInput("app87_text11", "","1", width = "180px",height="40px"))),
...
div(textAreaInput("app87_email", "","", width = "100%",height="40px"),style="text-align: center;font-weight: 1000;color:red"),
							actionButton(
                 inputId = "send_button",
                 label = "Submit",
                 styleclass = "info",
