drawbarchart<-function(data,app118_select1,app118_select2,app118_select3,app118_text1,app118_text2,app118_text3,app118_text4,app118_text5,app118_text6,app118_text7,app118_text8){	
...
colorbase<-c(app118_text1,app118_text2,app118_text3,app118_text4,app118_text5)
...
p<-ggplot(data=data,aes(x=time,y=value,colour=group,group=group))+ geom_line()+scale_colour_manual(values=mycolors)+
			scale_fill_manual(values=mycolors)+labs(title=app118_text6)+
			xlab(app118_text7)+ ylab(app118_text8)+theme_bw() +
