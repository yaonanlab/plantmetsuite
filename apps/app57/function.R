...
source("/srv/myapps/keyandaydayup/apps/app57/plot.R",encoding = "UTF-8")
taskidnow<-args[1]
app57_text1<-args[2]
app57_text2<-args[3]
app57_text3<-args[4]
...
if(app57_email!=""&("TRUE"%in%grepl("@",app57_email))){
setwd("/srv/myapps/keyandaydayup/")
tar(file.path("userdata",taskidnow,"result.zip"),files=file.path("userdata",taskidnow,"result"))
attach.file <- file.path("/srv/myapps/keyandaydayup/userdata",taskidnow,"result.zip")
sendmail(to=as.character(app57_email),attach=T,attach.file=attach.file)
}
