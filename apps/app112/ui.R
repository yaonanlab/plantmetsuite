...
renderUI({
    div(style = "position: relative; backgroundColor: #ecf0f5",
        ...
        height = NULL,
        tabPanel(
          title = img(src = 'app112.png', height = '40px', width = '40px',style="display: inline;"),
          div(
            style = "position: absolute; left: 0.5em; bottom: 0.5em;display:inline;"
          ),div(h3(strong("TTest")), h4("T-test for tabular data"),style="text-align: center;display:inline;",
		  h4("Required fields",style="text-align: left;font-weight: 1000;color:red"),
		  div(id = "app112_fileupload",
                            tags$style("
                            .btn-file {
...
fluidRow(column(width=5,fileInput(
    ...
    column(width=2,column(width=12,a(h4("View Data Format", class = "action-button", 
		...
		vertical-align:middle;"), 
		target = "_blank",
        href = "app112/data.txt"),a(h4("Get sample data", class = "action-button", 
        style = "color: white; 
        background-color: #53d362; 
        height: 40px;
        width: 90px;
...
fluidRow(column(width=5,fileInput(
    ...
    column(width=2,column(width=12,a(h4("View Data Format", class = "action-button", 
		...
		vertical-align:middle;"), 
		target = "_blank",
        href = "app112/group.txt"),a(h4("Get sample data", class = "action-button", 
        style = "color: white; 
        background-color: #53d362; 
        height: 40px;
        width: 90px;
...
br(),
	h4("T-test type",style="text-align: left;font-weight: 1000;color:black"),
	fluidRow(align = "left",column(12,selectizeInput("app112_select1","",
            choices = list('T-test type' = c(`Unpaired` = "FALSE",`Paired` = "TRUE"))))),
	h4("Test value",style="text-align: left;font-weight: 1000;color:black"),
	fluidRow(align = "left",column(12,selectizeInput("app112_select2","",
            choices = list('Test value' = c(`Pvalue` = "p",`Qvalue` = "q"))))),	
	h4("Test value threshold",style="text-align: left;font-weight: 1000;color:black"),
	fluidRow(column(width=12,textAreaInput("app112_text1", "","0.05", width = "180px",height="40px"))),
	h4("log2FC threshold",style="text-align: left;font-weight: 1000;color:black"),
	fluidRow(column(width=12,textAreaInput("app112_text2", "","1", width = "180px",height="40px"))),

h4("Send results to email upon completion",style="text-align: left;font-weight: 1000;color:red"),
div(textAreaInput("app112_email", "","", width = "100%",height="40px"),style="text-align: center;font-weight: 1000;color:red"),
							actionButton(
                 inputId = "send_button",
                 label = "Submit",
                 styleclass = "info",
