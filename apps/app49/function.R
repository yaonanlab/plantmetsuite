...
source("/srv/myapps/keyandaydayup/apps/app49/plot.R",encoding = "UTF-8")
taskidnow<-args[1]
app49_text1<-args[2]
app49_text2<-args[3]
app49_text3<-args[4]
...
if(app49_email!=""&("TRUE"%in%grepl("@",app49_email))){
setwd("/srv/myapps/keyandaydayup/")
tar(file.path("userdata",taskidnow,"result.zip"),files=file.path("userdata",taskidnow,"result"))
attach.file <- file.path("/srv/myapps/keyandaydayup/userdata",taskidnow,"result.zip")
sendmail(to=as.character(app49_email),attach=T,attach.file=attach.file)
}
