drawbarchart<-function(data,app117_select1,app117_select2,app117_select3,app117_text1,app117_text2,app117_text3,app117_text4,app117_text5,app117_text6,app117_text7,app117_text8){	
...
colorbase<-c(app117_text1,app117_text2,app117_text3,app117_text4,app117_text5)
...
mycolors <- colorRampPalette(colorbase)(colornumber) 
	...
	if(app117_select1=="1"){ 
		if(app117_select2=="1"){
			...
			scale_fill_manual(values=mycolors)+labs(title=app117_text6)+
			geom_text(mapping = aes(label = value), size = 5, colour = 'black', 
            position = position_dodge2(width = 0.9, preserve = 'single'), 
            vjust = -0.2, hjust = 0.5)+ xlab(app117_text7)+ ylab(app117_text8)+theme_bw() +
...
theme(axis.text.x = element_text(angle=45, hjust=.5, vjust=.5))+theme(axis.title.y = element_text(margin = margin(r = 20)))+theme(axis.title.x = element_text(margin = margin(t = 20)))
			...
			geom_bar(stat="identity",position="dodge")+
			scale_fill_manual(values=mycolors)+labs(title=app117_text6)+
			  xlab(app117_text7)+ ylab(app117_text8)+theme_bw() +
theme(panel.grid.major=element_blank(),panel.grid.minor=element_blank())+
theme(plot.title = element_text(vjust =1,hjust = 0.5,size=18,face="bold"))+
theme(axis.text.x = element_text(angle=45, hjust=.5, vjust=.5))+theme(axis.title.y = element_text(margin = margin(r = 20)))+theme(axis.title.x = element_text(margin = margin(t = 20)))
)}
...
theme(axis.text.x = element_text(angle=45, hjust=.5, vjust=.5))+theme(axis.title.y = element_text(margin = margin(r = 20)))+theme(axis.title.x = element_text(margin = margin(t = 20)))
			...
			geom_bar(stat="identity")+
			scale_fill_manual(values=mycolors)+
			labs(title=app117_text6)+ xlab(app117_text7)+ ylab(app117_text8)+theme_bw() +
theme(panel.grid.major=element_blank(),panel.grid.minor=element_blank())+
theme(plot.title = element_text(vjust =1,hjust = 0.5,size=18,face="bold"))+
theme(axis.text.x = element_text(angle=45, hjust=.5, vjust=.5))+theme(axis.title.y = element_text(margin = margin(r = 20)))+theme(axis.title.x = element_text(margin = margin(t = 20)))
)
	...
	if(app117_select1=="3"){ 
		if(app117_select2=="1"){
            ...
            position = position_dodge2(width = 0.9, preserve = 'single'), 
            vjust = 0.5, hjust = 1.5)+
			coord_flip()+ xlab(app117_text7)+ ylab(app117_text8)+theme_bw() +
theme(panel.grid.major=element_blank(),panel.grid.minor=element_blank())+
theme(plot.title = element_text(vjust =1,hjust = 0.5,size=18,face="bold"))+
theme(axis.text.x = element_text(angle=45, hjust=.5, vjust=.5))+theme(axis.title.y = element_text(margin = margin(r = 20)))+theme(axis.title.x = element_text(margin = margin(t = 20)))
)
