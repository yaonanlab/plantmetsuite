...
renderUI({
    div(
      ...
      tabBox(
        ...
        height = NULL,
        tabPanel(
          title = img(src = 'app99.png', height = '40px', width = '40px',style="display: inline;"),
          div(
	...
	fluidRow(column(width=5,fileInput(
		...
		column(width=2,column(width=12,a(h4("View sample data", class = "action-button", 
                 style = "color: white; 
					   ...
					   vertical-align:middle;
					   "), target = "_blank",
                            href = "app99/sample.mzXML"),a(h4("Download sample data", class = "action-button", 
                 style = "color: white; 
                       background-color: #53d362; 
                       height: 40px;
                       width: 90px;
...
div(textAreaInput("app99_email", "","", width = "100%",height="40px"),style="text-align: center;font-weight: 1000;color:red"),
